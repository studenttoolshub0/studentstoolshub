    ...
    const parseInline = (text: string) => {
        return text
            ...
            .replace(/\[(.*?)\]\((.*?)\)/g, (match, label, href) => {
                ...
                const isDoFollow = !isExternal || href.includes('cgpahub.com') || href.includes('https://subsidypk.com') || href.includes(' https://www.gyaanpost.com') || href.includes('https://growithmoney.com');
